...
input_folder = r'D:\Dataset\L1_O3b_data\4s_Dataset'  # Folder path containing spectrogram images
output_folder = r'D:\Dataset\L1_O3b_data\4s'  # Folder path to save processed images
