...
input_folder = r'D:\Dataset\H1_O3a_data\4s_Dataset'  # Folder path containing spectrogram images
output_folder = r'D:\Dataset\H1_O3a_data\4s'  # Folder path to save processed images
